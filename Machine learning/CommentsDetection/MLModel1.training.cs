...
namespace CommentsDetection
{
    public partial class MLModel1
    {
        public const string RetrainFilePath =  @"C:\Users\ASUS\Downloads\Datos_Misoginos_Limpios.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Conversion.MapValueToKey(outputColumnName:@"Etiqueta",inputColumnName:@"Etiqueta",addKeyValueAnnotationsAsText:false)      
                                    .Append(mlContext.MulticlassClassification.Trainers.TextClassification(labelColumnName: @"Etiqueta", sentence1ColumnName: @"Comentario"))      
